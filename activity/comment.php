...
<li id="acomment-<?php bp_activity_comment_id(); ?>">
	...
	<div class="acomment-options">
		...
		<?php if ( is_user_logged_in() && bp_activity_can_comment_reply( bp_activity_current_comment() ) ) : ?>
			...
			<a href="#acomment-<?php bp_activity_comment_id(); ?>" class="comment-reply bp-primary-action" id="acomment-reply-<?php bp_activity_id(); ?>-from-<?php bp_activity_comment_id(); ?>" data-id="<?php bp_activity_comment_id(); ?>"><?php _e( 'Reply', 'buddypress' ); ?></a>
