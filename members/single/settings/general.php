...
<form action="<?php echo bp_displayed_user_domain() . bp_get_settings_slug() . '/general'; ?>" method="post" class="standard-form" id="settings-form">
	...
	<label for="email"><?php _e( 'Account Email <span>(update email will change current email address)</span>', 'buddypress' ); ?></label>
	...
	<input type="password" name="pass1" id="pass1" size="16" value="" placeholder="New Password" class="settings-input small password-entry" <?php bp_form_field_attributes( 'password' ); ?>/> &nbsp;<?php //_e( 'New Password', 'buddypress' ); ?><br />
    <div id="pass-strength-result"></div>
	<label for="pass2" class="bp-screen-reader-text"><?php
		/* translators: accessibility text */
		_e( 'Repeat New Password', 'buddypress' );
		?></label>
	<input type="password" name="pass2" id="pass2" size="16" value="" placeholder="Repeat New Password" class="settings-input small password-entry-confirm" <?php bp_form_field_attributes( 'password' ); ?>/> &nbsp;<?php //_e( 'Repeat New Password', 'buddypress' ); ?>
