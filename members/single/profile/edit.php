	...
	while ( bp_profile_groups() ) : bp_the_profile_group(); ?>
		...
		<form action="<?php bp_the_profile_group_edit_form_action(); ?>" method="post" id="profile-edit-form"
			...
			<div class="hr-title hr-full hr-double">
				<abbr><?php printf( __( "Editing Profile", "buddypress" ), bp_get_the_profile_group_name() ); /*printf( __( "Editing '%s' Profile Group", "buddypress" ), bp_get_the_profile_group_name() );*/ ?></abbr>
			</div>
...
var field_18 = "<?= $current_user->user_email;?>";

jQuery("input#field_18").val(field_18);
</script>