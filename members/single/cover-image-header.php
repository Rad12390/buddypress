...
do_action( 'bp_before_member_header' ); ?>
	...
	<div id="item-header-content">
		...
		<?php if ( bp_is_active( 'activity' ) && bp_activity_do_mentions() ) : ?>
			<h4 class="user-nicename hover-tip click-tip" data-toggle="tooltip" data-container="body" data-title="<?php bp_last_activity( bp_displayed_user_id() ); ?>" data-placement="bottom"><?= xprofile_get_field_data(1, get_current_user_id() )." ".xprofile_get_field_data(30, get_current_user_id() ) ?></h4>
		<?php endif; ?>
